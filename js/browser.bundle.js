...
$('#disclaimerConsent').onchange=e=>$('#acceptDisclaimer').disabled=!e.target.checked;$('#acceptDisclaimer').onclick=()=>{disclaimerAccepted=true;$('#disclaimerModal').classList.remove('open');directGo(3)};$('#disclaimerBack').onclick=()=>$('#disclaimerModal').classList.remove('open');
